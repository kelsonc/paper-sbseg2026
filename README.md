...
The same notebook can also be executed non-interactively with Jupyter nbconvert after its dataset paths have been configured:

```bash
jupyter nbconvert --to notebook --execute notebooks/notebook_4.ipynb \
  --output notebook_4_executed.ipynb \
